  ...
  return [
    {
      ...
      content: [
        ...
        '生成搜索 query 时优先使用风格、语种、年代、人声、能量、编曲质感等音乐属性词；避免裸用时间词、场景意象词或过宽泛的情绪词。',
        '知识库和 sourceStyleSeeds 只是参考，不是固定模板；expand_queries 应主动扩展具体相邻风格、地区、年代或 vocal/energy 修饰，不要逐字照抄整组模板。',
