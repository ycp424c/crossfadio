...
export const PUBLIC_SELECTION_REASON_COPY = {
  ...
  rotation_track_suppression: '这首歌仍在最近 12 个成功选歌轮次的间隔内，本轮先不重复。',
  rotation_track_penalty: '这首歌最近出现过，本轮优先给其他候选更多空间。',
  rotation_frequency_penalty: '这首歌在近期选歌轮次中出现较多，本轮进一步降低重复。',
  rotation_final_rejection: '最后校验发现这首歌仍在轮次间隔内，本轮不重复加入。',
