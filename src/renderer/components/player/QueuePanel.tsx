...
export function QueuePanel(props: QueuePanelProps): JSX.Element {
  return (
    <section className="rounded-xl border border-orange-200/15 bg-black/25 p-4">
      <div className="mb-3 flex items-center justify-between">
        <h3 className="inline-flex items-center gap-2 text-lg font-semibold text-zinc-100">
          <ListMusic className="h-5 w-5 text-orange-200" />
          播放队列
        </h3>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className={`mt-1 block truncate text-xs ${isCurrent ? 'text-rose-200' : 'text-zinc-500'}`}>
